...
public class SmsRecipientForCandidateFromEvaluationFetcher implements RecipientFetcher<SmsRecipient> {
	...
	@Override
	public SmsRecipient getRecipient(final Entity entity, final String eventType) {
