...
@NoArgsConstructor
@Getter
public class InterviewersSortingProcessorTestData {

	private Map<Integer, List<InterviewerData>> dayWiseInterviewers;
	private Map<Integer, List<String>> dayWiseInterviewersResult;
	private List<InterviewerData> duplicateInterviewers;
}
