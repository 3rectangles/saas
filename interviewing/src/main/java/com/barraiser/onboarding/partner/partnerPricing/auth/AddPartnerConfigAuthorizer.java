...
@Component
@AllArgsConstructor
public class AddPartnerConfigAuthorizer implements GraphQLAbacAuthorizer {
	public static final String ERROR_MESSAGE_FOR_UNAUTHENTICATED_USER = "User does not have permission to update pricing info";
