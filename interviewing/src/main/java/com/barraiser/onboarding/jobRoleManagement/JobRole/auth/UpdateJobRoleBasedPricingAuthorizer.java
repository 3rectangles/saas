...
package com.barraiser.onboarding.jobRoleManagement.JobRole.auth;
...
@Component
@AllArgsConstructor
public class UpdateJobRoleBasedPricingAuthorizer implements GraphQLAbacAuthorizer {
	public static final String ERROR_MESSAGE_FOR_UNAUTHENTICATED_USER = "User does not have permission to update job role based pricing info";
