...
@AllArgsConstructor
@Component
public class StopInterviewConfirmationLifecycleProcessor implements CancellationProcessor {
	...
	public void process(final CancellationProcessingData data) throws Exception {
		final Optional<InterviewToStepFunctionExecutionDAO> interviewToStepFunctionExecutionDAOOptional = this.interviewToStepFunctionExecutionRepository
				.findTopByInterviewIdAndFlowTypeAndRescheduleCountOrderByCreatedOnDesc(data.getInterviewId(),
						FlowType.INTERVIEW_CONFIRMATION,
