...
public class EvaluationStrategy_V6Constants {

	public static class ModifiedWeightage {
		public static Map<String, Double> difficultyMap = Map.ofEntries(
				Map.entry("EASY_1.0", 1.5D),
				Map.entry("EASY_2.0", 1.5D),
				Map.entry("EASY_3.0", 1.5D),
				Map.entry("EASY_4.0", 1.5D),
				Map.entry("EASY_5.0", 1.5D),
				...
				Map.entry("HARD_6.0", 1.5D),
				Map.entry("HARD_7.0", 1.5D),
				Map.entry("HARD_8.0", 1.5D),
				Map.entry("HARD_9.0", 2D),
				Map.entry("HARD_10.0", 2D));
	...
	public enum QuestionType {
		...
		public static EvaluationStrategy_V6Constants.QuestionType fromString(
				final String difficulty) {
			for (final EvaluationStrategy_V6Constants.QuestionType qt : values()) {
	...
	public enum FeedbackDifficulty {
		...
		public static EvaluationStrategy_V6Constants.FeedbackDifficulty fromString(
				final String status) {
			for (final EvaluationStrategy_V6Constants.FeedbackDifficulty fd : values()) {
