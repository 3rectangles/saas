...
public class EvaluationStrategy_V10Constants {
	...
	public enum QuestionType {
		...
		public static EvaluationStrategy_V10Constants.QuestionType fromString(
				final String difficulty) {
			for (final EvaluationStrategy_V10Constants.QuestionType qt : values()) {
	...
	public enum FeedbackDifficulty {
		...
		public static EvaluationStrategy_V10Constants.FeedbackDifficulty fromString(
				final String status) {
			for (final EvaluationStrategy_V10Constants.FeedbackDifficulty fd : values()) {
