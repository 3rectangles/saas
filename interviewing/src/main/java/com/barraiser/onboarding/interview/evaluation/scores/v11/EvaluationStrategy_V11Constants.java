...
public class EvaluationStrategy_V11Constants {
	...
	public enum QuestionType {
		...
		public static EvaluationStrategy_V11Constants.QuestionType fromString(
				final String difficulty) {
			for (final EvaluationStrategy_V11Constants.QuestionType qt : values()) {
	...
	public enum FeedbackDifficulty {
		...
		public static EvaluationStrategy_V11Constants.FeedbackDifficulty fromString(
				final String status) {
			for (final EvaluationStrategy_V11Constants.FeedbackDifficulty fd : values()) {
