...
@Component
@AllArgsConstructor
public class FeedbackLengthFlagCalculator_V13 {
	public static final Integer MIN_NUMBER_OF_QUESTIONS = 3;

	public List<QuestionData> calculate(List<QuestionData> questionsOfInterview, final InterviewData interview) {
		if (interview.getIsSaasInterview()) {
			return questionsOfInterview;
		}
	...
	private EvaluationStrategy_V13Constants.FeedbackLengthFlag getFeedbackLengthBasedOnSD(final Integer feedbackLength,
		...
		return feedbackLength >= mean - (standardDeviation / 2)
				? feedbackLength > mean + (standardDeviation / 6)
						? EvaluationStrategy_V13Constants.FeedbackLengthFlag.HIGH
						: EvaluationStrategy_V13Constants.FeedbackLengthFlag.MID
				: EvaluationStrategy_V13Constants.FeedbackLengthFlag.LOW;
	}

	private EvaluationStrategy_V13Constants.FeedbackLengthFlag getFeedbackLengthBasedOnPercentile(
