...
public class FeedbackWeightageCalculator_V11 {
	...
	private static final List<Map<String, Object>> difficultyToWeightageMapping = List.of(
			Map.of(
					FEEDBACK_DIFFICULTY, EvaluationStrategy_V11Constants.FeedbackDifficulty.HARD,
			...
			Map.of(
					...
					MODIFIED_WEIGHTAGE, 1.5D),
			Map.of(
					FEEDBACK_DIFFICULTY, EvaluationStrategy_V11Constants.FeedbackDifficulty.MODERATE,
			...
			Map.of(
					...
					MODIFIED_WEIGHTAGE, 2D),
			Map.of(
					FEEDBACK_DIFFICULTY, EvaluationStrategy_V11Constants.FeedbackDifficulty.EASY,
					RATING_LOWER_BOUND, 9D,
					RATING_UPPER_BOUND, 10D,
					MODIFIED_WEIGHTAGE, 1.5D),
			Map.of(
	...
	public static Double getModifiedWeightage(final EvaluationStrategy_V11Constants.FeedbackDifficulty difficulty,
			final Float rating) {
