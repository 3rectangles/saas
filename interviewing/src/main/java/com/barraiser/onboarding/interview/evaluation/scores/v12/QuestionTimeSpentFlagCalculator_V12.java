...
public class QuestionTimeSpentFlagCalculator_V12 {
	...
	public static final EvaluationStrategy_V12Constants.QuestionTimeSpentFlag DEFAULT_TIME_SPENT_FLAG = EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.MID;
	...
	private static final List<Map<String, Object>> questionTimeToFlagMapping = List.of(
			Map.of(
					...
					TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.MID),
			Map.of(
					TIME_SPENT_LOWER_BOUND, 0,
					TIME_SPENT_UPPER_BOUND, 90,
					TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.VERY_LOW),
			Map.of(
					TIME_SPENT_LOWER_BOUND, 90,
					TIME_SPENT_UPPER_BOUND, 180,
					TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.LOW),
			Map.of(
			...
			Map.of(
					...
					TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.HIGH),
			Map.of(
					TIME_SPENT_LOWER_BOUND, 600,
					TIME_SPENT_UPPER_BOUND, Integer.MAX_VALUE,
					TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.VERY_HIGH));

	public static EvaluationStrategy_V12Constants.QuestionTimeSpentFlag calculate(final Long startTime,
			final Long endTime) {
		if (startTime != null && endTime != null) {
			...
			for (final Map<String, Object> obj : questionTimeToFlagMapping) {
				if (totalTimeSpent > (Integer) obj.get(TIME_SPENT_LOWER_BOUND)
					...
					return (EvaluationStrategy_V12Constants.QuestionTimeSpentFlag) obj.get(TIME_SPENT_FLAG);
				}
			}
		}
