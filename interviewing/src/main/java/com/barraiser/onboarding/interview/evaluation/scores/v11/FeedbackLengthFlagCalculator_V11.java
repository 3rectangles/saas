...
@Component
@AllArgsConstructor
public class FeedbackLengthFlagCalculator_V11 {
	...
	private EvaluationStrategy_V11Constants.FeedbackLengthFlag getFeedbackLengthBasedOnSD(final Integer feedbackLength,
		...
		return feedbackLength >= mean - (standardDeviation / 2)
				? feedbackLength > mean + (standardDeviation / 6)
						? EvaluationStrategy_V11Constants.FeedbackLengthFlag.HIGH
						: EvaluationStrategy_V11Constants.FeedbackLengthFlag.MID
				: EvaluationStrategy_V11Constants.FeedbackLengthFlag.LOW;
	}

	private EvaluationStrategy_V11Constants.FeedbackLengthFlag getFeedbackLengthBasedOnPercentile(
