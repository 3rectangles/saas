...
public class FeedbackWeightageCalculator_V12 {
	...
	private static final List<Map<String, Object>> difficultyToWeightageMapping = List.of(
			Map.of(
					FEEDBACK_DIFFICULTY, EvaluationStrategy_V12Constants.FeedbackDifficulty.HARD,
			...
			Map.of(
					...
					MODIFIED_WEIGHTAGE, 1.5D),
			Map.of(
					FEEDBACK_DIFFICULTY, EvaluationStrategy_V12Constants.FeedbackDifficulty.MODERATE,
			...
			Map.of(
					...
					MODIFIED_WEIGHTAGE, 2D),
			Map.of(
					FEEDBACK_DIFFICULTY, EvaluationStrategy_V12Constants.FeedbackDifficulty.EASY,
					RATING_LOWER_BOUND, 9D,
					RATING_UPPER_BOUND, 10D,
					MODIFIED_WEIGHTAGE, 1.5D),
			Map.of(
