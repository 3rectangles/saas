...
@Component
@Log4j2
public class JobRoleHiringManagerDataFetcher extends AuthorizedGraphQLQuery<List<PartnerRepDetails>> {
	...
	public JobRoleHiringManagerDataFetcher(AuthorizationServiceFeignClient authorizationServiceFeignClient,
	...
	public List<List<String>> typeNameMap() {
		return List.of(
				List.of(QUERY_TYPE, "fetchHiringManagers"));
	}
}
