...
public class QuestionTypeWeightageCalculator_V12 {
	...
	private static final List<Map<String, Object>> questionTypeToModifiedWeightageMapping = List.of(
			Map.of(
					QUESTION_TYPE, EvaluationStrategy_V12Constants.QuestionType.REQUIRED,
					RATING_LOWER_BOUND, 0D,
					RATING_UPPER_BOUND, 10D,
					MODIFIED_WEIGHTAGE, 1D),
			Map.of(
					QUESTION_TYPE, EvaluationStrategy_V12Constants.QuestionType.GOOD_TO_KNOW,
	...
	public static Double getModifiedWeightage(final EvaluationStrategy_V12Constants.QuestionType questionType,
			final Float rating) {
