...
public class ModifiedWeightageCalculator_V10 {
	...
	private static final List<Map<String, Object>> flagToModifiedWeightageMapping = List.of(
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V10Constants.QuestionTimeSpentFlag.VERY_HIGH,
					FEEDBACK_LENGTH_FLAG, EvaluationStrategy_V10Constants.FeedbackLengthFlag.HIGH,
					MODIFIED_WEIGHTAGE, 4D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V10Constants.QuestionTimeSpentFlag.VERY_HIGH,
					FEEDBACK_LENGTH_FLAG, EvaluationStrategy_V10Constants.FeedbackLengthFlag.MID,
					MODIFIED_WEIGHTAGE, 3D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V10Constants.QuestionTimeSpentFlag.HIGH,
					FEEDBACK_LENGTH_FLAG, EvaluationStrategy_V10Constants.FeedbackLengthFlag.HIGH,
					MODIFIED_WEIGHTAGE, 3D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V10Constants.QuestionTimeSpentFlag.HIGH,
					...
					MODIFIED_WEIGHTAGE, 3D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V10Constants.QuestionTimeSpentFlag.LOW,
					FEEDBACK_LENGTH_FLAG, EvaluationStrategy_V10Constants.FeedbackLengthFlag.LOW,
					MODIFIED_WEIGHTAGE, 1.5D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V10Constants.QuestionTimeSpentFlag.VERY_LOW,
					FEEDBACK_LENGTH_FLAG, EvaluationStrategy_V10Constants.FeedbackLengthFlag.MID,
					MODIFIED_WEIGHTAGE, 1.5D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V10Constants.QuestionTimeSpentFlag.VERY_LOW,
	...
	public static Double getModifiedWeightageForFeedbackLengthAndQuestionTime(
			final EvaluationStrategy_V10Constants.FeedbackLengthFlag feedbackLengthFlag,
			final EvaluationStrategy_V10Constants.QuestionTimeSpentFlag questionTimeFlag) {
