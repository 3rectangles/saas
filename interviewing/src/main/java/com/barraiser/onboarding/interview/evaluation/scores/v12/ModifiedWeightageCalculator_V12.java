...
public class ModifiedWeightageCalculator_V12 {
	...
	private static final List<Map<String, Object>> saasFlagToModifiedWeightageMapping = List.of(
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.VERY_HIGH,
					MODIFIED_WEIGHTAGE, 4D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.HIGH,
					MODIFIED_WEIGHTAGE, 3D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.MID,
					MODIFIED_WEIGHTAGE, 2D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.LOW,
					MODIFIED_WEIGHTAGE, 2D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.VERY_LOW,
					MODIFIED_WEIGHTAGE, 2D));
	private static final List<Map<String, Object>> iaasFlagToModifiedWeightageMapping = List.of(
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.VERY_HIGH,
					FEEDBACK_LENGTH_FLAG, EvaluationStrategy_V12Constants.FeedbackLengthFlag.HIGH,
					MODIFIED_WEIGHTAGE, 4D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.VERY_HIGH,
					FEEDBACK_LENGTH_FLAG, EvaluationStrategy_V12Constants.FeedbackLengthFlag.MID,
					MODIFIED_WEIGHTAGE, 3D),
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.HIGH,
					FEEDBACK_LENGTH_FLAG, EvaluationStrategy_V12Constants.FeedbackLengthFlag.HIGH,
			...
			Map.of(
					QUESTION_TIME_SPENT_FLAG, EvaluationStrategy_V12Constants.QuestionTimeSpentFlag.LOW,
					FEEDBACK_LENGTH_FLAG, EvaluationStrategy_V12Constants.FeedbackLengthFlag.LOW,
	...
	public static Double getModifiedWeightageForFeedbackLengthAndQuestionTime(
			...
			final EvaluationStrategy_V12Constants.QuestionTimeSpentFlag questionTimeFlag) {
		if (feedback.getIsSaasFeedback()) {
			...
			final EvaluationStrategy_V12Constants.FeedbackLengthFlag feedbackLengthFlag = EvaluationStrategy_V12Constants.FeedbackLengthFlag
