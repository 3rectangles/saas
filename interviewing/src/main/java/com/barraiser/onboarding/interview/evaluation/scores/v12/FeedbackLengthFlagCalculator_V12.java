...
@Component
@AllArgsConstructor
public class FeedbackLengthFlagCalculator_V12 {
	...
	private EvaluationStrategy_V12Constants.FeedbackLengthFlag getFeedbackLengthBasedOnSD(final Integer feedbackLength,
		...
		return feedbackLength >= mean - (standardDeviation / 2)
				? feedbackLength > mean + (standardDeviation / 6)
						? EvaluationStrategy_V12Constants.FeedbackLengthFlag.HIGH
						: EvaluationStrategy_V12Constants.FeedbackLengthFlag.MID
				: EvaluationStrategy_V12Constants.FeedbackLengthFlag.LOW;
	}

	private EvaluationStrategy_V12Constants.FeedbackLengthFlag getFeedbackLengthBasedOnPercentile(
