...
import com.barraiser.common.graphql.input.GetRecruitersInput;
...
public class RecruiterToQueryInputVariablesMapper implements EntityToQueryInputVariablesMapper {
	private final ObjectMapper objectMapper;

	@Override
	public EntityType entityType() {
		return EntityType.RECRUITER;
	}
